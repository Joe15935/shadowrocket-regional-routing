...
def verify():
    ...
    main=f'https://raw.githubusercontent.com/{repo}/main/shadowrocket-ultimate.conf'
    ...
    def one(pair):
        ...
        common=['curl','-q','--fail','--silent','--show-error','--location','--proto','=https','--max-time','45','--retry','2']
